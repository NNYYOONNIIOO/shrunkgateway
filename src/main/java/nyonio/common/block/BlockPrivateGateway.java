...
public class BlockPrivateGateway extends BlockCelestialGateway {

    public BlockPrivateGateway() {
        super();
    }

    @Override
    public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack) {
        TilePrivateGateway gateway = MiscUtils.getTileAt(worldIn, pos, TilePrivateGateway.class, true);
        if(gateway != null) {
